...
struct UCanvas {
public:
	__forceinline bool GetFunction() {
		static uintptr_t fn = UObject::FindObject("Function Engine.Canvas.K2_DrawText");
		return fn;
	}

	__forceinline uintptr_t GetFont() {
		static uintptr_t font = UObject::FindObject("Font Roboto.Roboto");
		return font;
	}
	...
	__forceinline void ADrawText(Vector2 ScreenPosition, FString RenderText, FLinearColor RenderColor, bool centered, bool bOutlined) {
		...
		params.RenderFont = (UObject*)GetFont();
		...
		UObject::ProcessEvent((uintptr_t)this, (void*)GetFunction(), &params);
	}
...
public:
	Vector3 RelativeLocation() {
		return *reinterpret_cast<Vector3*>(reinterpret_cast<uintptr_t>(this) + 0x128);
	}
};
...
public:
	ARootComponent* RootComponent() {
		return reinterpret_cast<ARootComponent*>(*(reinterpret_cast<uint64_t*>(reinterpret_cast<uintptr_t>(this) + 0x190)));
	}

	uint64_t Mesh() {
		return *(reinterpret_cast<uint64_t*>(reinterpret_cast<uintptr_t>(this) + 0x310));
	}

	Vector3 GetBoneLocation(int Id) {
		auto mesh = Mesh();
		if (!mesh) return { 0, 0, 0 };
		auto function = reinterpret_cast<FMatrix * (__fastcall*)(uintptr_t, FMatrix*, int)>(GetBoneMatrix);
...
public:
	AFortPawn* AcknowledgedPawn() {
		return reinterpret_cast<AFortPawn*>(reinterpret_cast<uintptr_t>(this) + 0x330);
	}
...
public:
	APlayerController* PlayerController() {
		...
		return reinterpret_cast<APlayerController*>(*(uintptr_t*)(this + 0x30));
	}

	UGameViewportClient* ViewPortClient() {
		if (!this) return nullptr;
		return reinterpret_cast<UGameViewportClient*>(*(uintptr_t*)(this + 0x78));
	}
};
...
public:
	ULocalPlayer* LocalPlayer() {
		if (!this) return nullptr;
		return reinterpret_cast<ULocalPlayer*>(*(uintptr_t*)(this));
	}
};
...
public:
	ULocalPlayers* LocalPlayers() {
		if (!this) return nullptr;
		return reinterpret_cast<ULocalPlayers*>(*(uintptr_t*)(this + 0x38));
	}
};
...
public:
	UGameInstance* GameInstance() {
		return reinterpret_cast<UGameInstance*>(*(uintptr_t*)(this + 0x1B8));
	}
};
...
public:
	...
	static inline void SetupKeys() {
		...
		keys::Tab = FKey{ FName{ KismetStringLib->Conv_StringToName((L"Tab")) }, 0 };
		...
		keys::F1 = FKey{ FName{ KismetStringLib->Conv_StringToName((L"F1")) }, 0 };
		keys::F2 = FKey{ FName{ KismetStringLib->Conv_StringToName((L"F2")) }, 0 };
		keys::F3 = FKey{ FName{ KismetStringLib->Conv_StringToName((L"F3")) }, 0 };
		keys::F4 = FKey{ FName{ KismetStringLib->Conv_StringToName((L"F4")) }, 0 };
		keys::F5 = FKey{ FName{ KismetStringLib->Conv_StringToName((L"F5")) }, 0 };
		keys::F6 = FKey{ FName{ KismetStringLib->Conv_StringToName((L"F6")) }, 0 };
		keys::F7 = FKey{ FName{ KismetStringLib->Conv_StringToName((L"F7")) }, 0 };
		keys::F8 = FKey{ FName{ KismetStringLib->Conv_StringToName((L"F8")) }, 0 };
		keys::F9 = FKey{ FName{ KismetStringLib->Conv_StringToName((L"F9")) }, 0 };
		keys::W = FKey{ FName{ KismetStringLib->Conv_StringToName((L"W")) }, 0 };
		keys::A = FKey{ FName{ KismetStringLib->Conv_StringToName((L"A")) }, 0 };
		keys::S = FKey{ FName{ KismetStringLib->Conv_StringToName((L"S")) }, 0 };
		keys::D = FKey{ FName{ KismetStringLib->Conv_StringToName((L"D")) }, 0 };
		keys::SpaceBar = FKey{ FName{ KismetStringLib->Conv_StringToName((L"SpaceBar")) }, 0 };
		keys::LeftShift = FKey{ FName{ KismetStringLib->Conv_StringToName((L"LeftShift")) }, 0 };
	}
};
...
public:
	struct FString GetObjectName(UObject* Object) {
		static uintptr_t fn = NULL;
		if (!fn) {
			fn = UObject::FindObject(("Function Engine.KismetSystemLibrary.GetObjectName"));
		}
	...
	static KismetSystemLibrary* StaticClass() {
		static uintptr_t fn = NULL;
		if (!fn) {
			fn = UObject::FindObject(("Class FortniteGame.KismetSystemLibrary"));
		}

		return (KismetSystemLibrary*)fn;
	}
};
...
void vmt(void* addr, void* pDes, int index, void** ret)
{
	...
	{
		++methods;
	} while (*(std::uintptr_t*)((std::uintptr_t)vtable + (static_cast<unsigned long long>(methods) * 0x8)));
	auto vtable_buf = new uint64_t[methods * 0x8];
	for (auto count = 0; count < methods; ++count) 
	{
		vtable_buf[count] = *(std::uintptr_t*)((std::uintptr_t)vtable + (static_cast<unsigned long long>(count) * 0x8));
