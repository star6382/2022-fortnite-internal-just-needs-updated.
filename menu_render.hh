...
// Convert RGB values to FLinearColor
FLinearColor rgb(float R, float G, float B) {
	return { R / 255, G / 255, B / 255, 1 };
}

// Macros for minimum and maximum values
...
// Convert string to wide character string
...
#define M_PI 3.14159265358979323846264338327950288419716939937510
	...
	void SliderFloat(const char* name, float* value, float min, float max, const char* format = "%.0f")
	{
		...
		TextLeft(name, textPos, FLinearColor(1.0, 1.0, 1.0, 1.0), false, false);
